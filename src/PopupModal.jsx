    ...
    <>
      ...
      >
        <div className="popup-box">
          <button className="popup-close" id="popupCloseBtn" onClick={onClose}>
            &times;
          </button>
          ...
          <form className="popup-form" id="popupForm" onSubmit={handleSubmit}>
            <div className="popup-form-group">
              <input type="text" className="popup-input" placeholder="Name" required />
            </div>

            <div className="popup-form-group">
              <input type="email" className="popup-input" placeholder="Email (optional)" />
            </div>

            <div className="popup-form-group popup-phone-group">
              <select className="popup-input popup-country-select">
                <option value="+91">India (+91)</option>
                <option value="+1">USA (+1)</option>
                <option value="+44">UK (+44)</option>
                <option value="+971">UAE (+971)</option>
              </select>
              <input type="tel" className="popup-input" placeholder="Mobile Number" required />
            </div>
